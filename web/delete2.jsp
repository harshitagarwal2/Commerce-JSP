...
%>
<tr><td><input maxlength="20" type='checkbox' name='ID' value= "<%=id%>" </td> <td><%=id%></td> <td><%=name%></td> <td><%=gender%></td> <td><%= age %></td> <td><%= addr %></td> <td><%= mtype %></td> <td><%= sal %></td> <td><%= user %></td> <td><%= pass %></td> </tr>
<%
    }
%>
